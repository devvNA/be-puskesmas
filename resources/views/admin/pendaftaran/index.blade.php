    ...
    <div class="col-12">
        <div class="card border-0">
            <div class="card-header bg-white d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Daftar Pendaftaran
                    {{ isset($tanggal) && !empty($tanggal) ? 'Tanggal ' . date('d/m/Y', strtotime($tanggal)) : 'Hari Ini' }}
                    {{ isset($search) && !empty($search) ? "| Pencarian: '$search'" : '' }}
                    {{ isset($poli_id) && !empty($poli_id) ? "| Poli: " . ($poli_name ?? $poli_id) : '' }}
                </h5>
                <div class="d-flex">
            ...
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-12">
                        <form action="{{ route('admin.pendaftaran.search') }}" method="GET">
                            <div class="row g-2">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <span class="input-group-text bg-light">Kata Kunci</span>
                                        <input type="text" name="search" class="form-control" placeholder="Nama/No.RM"
                                            value="{{ $search ?? '' }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <span class="input-group-text bg-light">Poli</span>
