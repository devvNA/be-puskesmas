    ...
    <div class="row">
        <div class="col-12">
            <div class="card border-0">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.rekam-medis.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="pendaftaran_id" id="pendaftaran_id"
                                        ...
                                        <option value="" selected>-- Tidak Ada Pendaftaran --</option>
                                        @foreach ($pendaftaran as $p)
                                            <option value="{{ $p->id }}" data-pasien-id="{{ $p->pasien_id }}"
                                                {{ old('pendaftaran_id') == $p->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="resep" id="resep" rows="3" class="form-control @error('resep') is-invalid @enderror">{{ old('resep') }}</textarea>
                            @error('resep')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
